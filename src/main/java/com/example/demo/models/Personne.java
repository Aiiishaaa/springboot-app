...
public class Personne {
    ...
    // CascadeType.REMOVE : lors de la suppression d'une personne, il supprime également
    // les entités voitures.
    // CascadeType.REFRESH : lors de l'actualisation d'une personne, actualise également les entités
